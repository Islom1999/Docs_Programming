import{_ as n,o as a,c as s,a as e}from"./app-13ec2ce8.js";const t={},o=e(`<h1 id="📔-php-switch" tabindex="-1"><a class="header-anchor" href="#📔-php-switch" aria-hidden="true">#</a> 📔 PHP switch</h1><p>Bayonot switchturli shartlarga asoslangan turli harakatlarni bajarish uchun ishlatiladi.</p><h2 id="php-switch-bayonoti" tabindex="-1"><a class="header-anchor" href="#php-switch-bayonoti" aria-hidden="true">#</a> PHP switch bayonoti</h2><p>Bajarish uchun ko&#39;plab kod bloklaridan birini tanlashswitch uchun bayonotdan foydalaning .</p><p>Sintaksis</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token keyword">switch</span> <span class="token punctuation">(</span>n<span class="token punctuation">)</span> <span class="token punctuation">{</span>
